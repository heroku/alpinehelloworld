pipeline {
     environment {
       ...
       APP_NAME = "ulrich"
       STG_API_ENDPOINT = "ip10-0-0-3-cialgivi3nvgqghmcbu0-1993.direct.docker.labs.eazytraining.fr"
       STG_APP_ENDPOINT = "ip10-0-0-3-cialgivi3nvgqghmcbu0-80.direct.docker.labs.eazytraining.fr"
       PROD_API_ENDPOINT = "ip10-0-0-4-cialgivi3nvgqghmcbu0-1993.direct.docker.labs.eazytraining.fr"
       PROD_APP_ENDPOINT = "ip10-0-0-4-cialgivi3nvgqghmcbu0-80.direct.docker.labs.eazytraining.fr"
       INTERNAL_PORT = "5000"
     ...
     stage ('Login and Push Image on docker hub') {
        ...
        environment {
          ...
          steps {
             script {
               sh '''
                   echo $DOCKERHUB_PASSWORD_PSW | docker login -u $ID_DOCKER --password $DOCKERHUB_PASSWORD_PSW
